  ...
  return (
    <div className="mt-4">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-1">
        ...
        {assignees.length === 0 ? <span className="text-xs text-muted">None</span> : null}
      </div>
      {editable ? (
        <div className="mt-2 flex flex-col gap-1">
          {members.map((member: Assignee) => (
            ...
            >
              ...
              <span className="flex-1 truncate text-foreground/80" title={member.email}>
          ...
          {members.length === 0 ? (
            <span className="text-xs text-muted">No board members to assign.</span>
          ) : null}
        </div>
      ) : null}
    </div>
